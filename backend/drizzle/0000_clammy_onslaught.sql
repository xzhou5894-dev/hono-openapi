...
CREATE TABLE "settings" (
	"id" varchar PRIMARY KEY NOT NULL,
	"general_maintenance_enabled" boolean DEFAULT false NOT NULL,
	"general_rain_enabled" boolean DEFAULT false,
	"general_tip_enabled" boolean DEFAULT false,
	"game_blackjack_enabled" boolean DEFAULT true,
	"blackjack_min_bet_standard" integer DEFAULT 100 NOT NULL,
	"blackjack_max_bet_standard" integer DEFAULT 50000 NOT NULL,
	"blackjack_min_bet_whale" integer DEFAULT 1000 NOT NULL,
	"blackjack_max_bet_whale" integer DEFAULT 250000 NOT NULL,
	"blackjack_deck_count" integer DEFAULT 6 NOT NULL,
	"created_at" timestamp(3) DEFAULT now() NOT NULL,
	"updated_at" timestamp(3) DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "app_versions" (
	...
	CONSTRAINT "version_unique_idx" UNIQUE("app_id","version","platform")
);
--> statement-breakpoint
...
ALTER TABLE "blackjack_bets" ADD CONSTRAINT "blackjack_bets_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "blackjack_bets" ADD CONSTRAINT "blackjack_bets_game_id_blackjack_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."blackjack_games"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "rtg_settings_request_user_data" ADD CONSTRAINT "rtg_settings_request_user_data_request_id_rtg_settings_requests" FOREIGN KEY ("request_id") REFERENCES "public"."rtg_settings_requests"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "rtg_settings_request_custom_data" ADD CONSTRAINT "rtg_settings_request_custom_data_request_id_rtg_settings_reques" FOREIGN KEY ("request_id") REFERENCES "public"."rtg_settings_requests"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "game_session_auth_session_idx" ON "game_sessions" USING btree ("auth_session_id" text_ops);--> statement-breakpoint
CREATE INDEX "game_session_user_idx" ON "game_sessions" USING btree ("user_id" text_ops);--> statement-breakpoint
CREATE INDEX "auth_session_status_idx" ON "auth_sessions" USING btree ("status" enum_ops);--> statement-breakpoint
CREATE INDEX "auth_session_user_idx" ON "auth_sessions" USING btree ("user_id" text_ops,"created_at" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "JackpotContribution_jackpotId_gameSpinId_key" ON "jackpot_contributions" USING btree ("jackpot_id" text_ops,"game_spin_id" text_ops);
*/