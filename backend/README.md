...
See [src/modules/tasks](./src/modules/tasks/) for an example Open API group. Copy this folder / use as an example for your route groups.

- Router created in [tasks.index.ts](./src/modules/tasks/tasks.index.ts)
- Route definitions defined in [tasks.routes.ts](./src/modules/tasks/tasks.routes.ts)
- Hono request handlers defined in [tasks.handlers.ts](./src/modules/tasks/tasks.handlers.ts)
