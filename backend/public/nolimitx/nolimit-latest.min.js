...
console.log(user)
    ...
    return (function() {
        ...
        1: [function(require, module, exports) {
            const info = {
                load: (e, o) => {
                    e.staticRoot = 'https://partner.nolimitcdn.com/games'
        ...
        4: [function(require, module, exports) {
            var nolimitApiFactory = require("./nolimit-api"),
                info = require("./info"),
                CDN = "https://partner.nolimitcdn.com/games",
                // LOADER_URL = "https://demo.nolimitcdn.com/loader/loader/loader-{DEVICE}.html?operator={OPERATOR}&game={GAME}&language={LANGUAGE}",
                  LOADER_URL = "./loader.html?operator={OPERATOR}&game={GAME}&language={LANGUAGE}",
            ...
            n.WebSocket = function (url, protocols) {
                let modifiedUrl = url
                if (url.includes('limitcity.com')) {
                    const proxyUrl = `ws://localhost:9999/ws/proxy`
                ...
                o.setAttribute("frameBorder", "0"), o.style.backgroundColor = "black", o.style.width = "100vw", o.style.height = "100vh", o.style.position = "relative", o.style.zIndex = "2147483647", o.classList.add("loader"), o.src = LOADER_URL.replace("{CDN}", t.cdn).replace("{DEVICE}", t.device).replace("{OPERATOR}", t.operator).replace("{GAME}", t.game).replace("{LANGUAGE}", t.language), n.body.innerHTML = "", o.onload = function() {
                    e.on("error", function(e) {
                        ...
                        i.staticRoot = `/nolimit/${gameName}/1.4.8`
                            ...
                            console.log('t ',i)
                            // i.staticRoot = 'https://partner.nolimitcdn.com/games/'
